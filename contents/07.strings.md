...
// String str2 = slice; // Error, String is 'distinct' from char slice
...
// char[] slice = array; // Error, needs 'slicing' the array
...
// char* pointer = array; // Error, array does not decay to pointer, unlike in C
