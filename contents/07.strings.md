...
```c3
char[] cslice1 = "abc-utf8-encoded";
String str1 = "def-utf8-한글漢字♡";
String str2 = cslice1; // Error, String is 'distinct' from char slice
String str2 = (String)cslice1; // Ok, needs type casting, because it's distinct type
char[] cslice2 = str1; // Ok, no need to cast (char[]) because it's inlined in typedef
assert(cslice2.len == str1.len);
...
fn void test_tokenize()
{
    ...
    Splitter splitter = str.tokenize(", ");
    List {String} tokens;
