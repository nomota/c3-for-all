...
{
    Char32[] = rune_char.to_temp_utf32();
    return c32[0];
}
...
fn Char32 c8to32(String rune_char)
{
    Char32[1] c32 = rune_char.to_temp_utf32();
    return c32[0];
}

fn Char16 c8to16(String rune_char)
{
    Char16[] c16 = rune_char.to_temp_utf16();
    return c16[0];
}

fn String tu32to8(Char32[] c32s)
{
    return string::from_utf32(tmem, c32s);
}

fn String tu16to8(Char16[] c16s)
{
    return string::from_utf16(tmem, c16s);
}

fn Char16[] tu8to16(String u8)
{
    return u8.to_temp_utf16();
}

fn Char32[] tu8to32(String u8)
{
    return u8.to_temp_utf32();
}

fn void test_print() => @pool() // frees temporary memories
{
    Char16 c16 = c8to16("Å"); // 2byte European accented char
