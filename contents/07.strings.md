...
```c3
String s = tformat(String fmt, args...);
...
String s = tfrom_struct(struct_x);
```
...
String str;
Allocator allocx;
ZString zs = tformat_zstr(String fmt, args...);
...
String? s = from_utf32(allocx, Char32[] utf32);
String? s = from_utf16(allocx, Char16[] utf16);
String? s = from_wstring(allocx, WString wstring);
String? s = tfrom_wstring(WString wstring);
String? s = tfrom_utf16(Char16[] utf16);
...
* Note: `DString` implements `OutStream` interface, like this.
