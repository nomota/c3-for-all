...
fn void test_print() => @pool() // frees temporary memories
{
    ...
    io::printfn("%s", tu16to8(c16s)); // prints 😀♡한漢Ê🇰🇷
    io::printfn("%s", tu32to8(c32s)); // prints 𝄞ÆØ«»☆★
}
```
...
These are macros only available at compile time.
