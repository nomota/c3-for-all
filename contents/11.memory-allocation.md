...
Allocator allocx = &tr_alloc; // common interface
```
...
TrackingAllocator tr_alloc; // allocator struct
tr_alloc.init(mem); // properly unitialize
defer {
    tr_alloc.print_report();
    tr_alloc.free();
}
...
fn void main()
{
    TrackinAllocator tr_alloc;
    Allocator allocx = &tr_alloc;
